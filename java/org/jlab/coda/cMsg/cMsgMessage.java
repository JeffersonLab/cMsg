...
//            }
            ...
            if (length > 57) {
                sb.append("\">\n");
                sb.append(org.jlab.coda.cMsg.common.Base64.encodeToString(bytes, offset, length, true));
//                sb.append(b64Encoder.encodeToString(bites));
                ...
                sb.append("\">");
                sb.append(org.jlab.coda.cMsg.common.Base64.encodeToString(bytes, offset, length, false));
//                sb.append(b64Encoder.encodeToString(bites));
                sb.append("</binary>\n");
            }
        }
