...
enum msgId {
  ...
  CMSG_KEEP_ALIVE,
  CMSG_SHUTDOWN,
  CMSG_SUBSCRIBE_AND_GET_REQUEST,
  CMSG_SEND_AND_GET_REQUEST,
  CMSG_GET_RESPONSE,
  CMSG_SEND_REQUEST,
  CMSG_SEND_RESPONSE,
  ...
  CMSG_UN_SUBSCRIBE_AND_GET_REQUEST,
  CMSG_UN_SEND_AND_GET_REQUEST,
  CMSG_GET_RESPONSE_WITH_ACK,
  CMSG_SUBSCRIBE_RESPONSE_WITH_ACK,
  CMSG_GET_RESPONSE_IS_NULL
};
