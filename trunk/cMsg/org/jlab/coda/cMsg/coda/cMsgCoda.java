...
/**
 * This class implements a cMsg client in the CODA domain.
 *
 * @author Carl Timmer
 * @version 1.0
 */
...
//-----------------------------------------------------------------------------
     ...
     */
    public cMsgCoda(String UDL, String name, String description) throws cMsgException {
        this.UDL = UDL;
        this.name = name;
        ...
        try {
            ...
            throw new cMsgException("cMsgCoda: cannot find host name");
        }
...
//-----------------------------------------------------------------------------
     ...
     * In the CODA cMsg implementation, this method does nothing.
     */
...
//-----------------------------------------------------------------------------
    ...
    private void parseUDL(String UDL) throws cMsgException {
        ...
        // CODA domain UDL is of the form:   domainType://host:port/remainder
        // port or remainder is not necessary, and host might be "localhost"
...
class KeepAlive extends Thread {
     ...
     */
    public KeepAlive(cMsgCoda client, SocketChannel channel) {
        this.client  = client;
